...
export default function Home() {
  ...
  const birthdayDate = new Date("Jun 01, 2025") // Change this date accordingly
  const birthdayDate1 = new Date("Jun 02, 2025")
        ...
        <motion.div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-3xl shadow-xl shadow-rose-100 p-8 border-2 border-rose-200"
          ...
          <AnimatePresence mode="wait">
            ...
            {isBirthday ? (
              ...
              <Countdown key="countdown" targetDate={birthdayDate1} onCountdownEnd={() => setShowForYouBtn(true)} />
            )}
          </AnimatePresence>
        </motion.div>
      </motion.div>
