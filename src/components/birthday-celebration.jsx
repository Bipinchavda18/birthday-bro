  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To My Brother</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                Just a little reminder before your big day—you’re my favorite person. My days are brighter, my smiles are bigger, and life feels sweeter all because of you. Can’t wait to celebrate you!
                </p>
                <p className="text-pink-600 font-medium">May your upcoming birthday be filled with love, magic, and all the things that bring a smile to your face. Wishing you an early celebration of all the joy and happiness that’s coming your way! 💖</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
      ...
      >
        <div className="text-center">
          ...
          As your birthday approaches, may every wish you make come true. You deserve the world, and I’ll always be here to remind you of that!.
          </p>
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">As your birthday approaches, let’s always stay like this... together, forever. I cherish every moment with you! 🫶</p>
          </div>
        </div>
      </motion.div>
    </div>
